...
type Category = "all" | "wildlife" | "landscapes" | "vehicles" | "sunsets";
...
const galleryImages: GalleryImage[] = [
  ...
  {
    src: "/experience2.jpg",
    alt: "Open savanna road",
    category: "landscapes",
  },
  {
    src: "/vehicle1.jpg",
    alt: "Land Cruiser on safari",
    category: "vehicles",
    span: "tall",
  },
  {
    ...
    <>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-sand/70">
              Explore stunning moments captured during our safaris across East
              Africa. From majestic wildlife to breathtaking landscapes.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="bg-sand py-20 sm:py-28 lg:py-32">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection
            delay={400}
            className="mt-16 rounded-2xl border border-espresso/10 bg-card/50 px-6 py-8 text-center"
          >
            <h3 className="font-heading text-xl font-bold text-espresso">
              Share Your Journey
            </h3>
            <p className="mt-1 text-sm text-espresso/60">
              Tag us on our socials to be featured in our gallery.
            </p>
            <div className="mt-6 flex justify-center gap-6">
              {socialLinks.map((link) => (
                <Link
                  key={link.label}
                  href={link.href}
                  className="text-olive transition-all duration-200 hover:scale-110 hover:text-olive-soft"
